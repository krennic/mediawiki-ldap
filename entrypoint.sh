...
: ${MEDIAWIKI_HTML_PATH:=/var/www/html/}
: ${MEDIAWIKI_SETTINGS_PATH:=/var/www/html/settings}

# Copy LocalSettings.php to the right place (from docker volume)
echo "Copying LocalSettings.php from $MEDIAWIKI_SETTINGS_PATH to $MEDIAWIKI_HTML_PATH"
if [ ! -f $MEDIAWIKI_SETTINGS_PATH/LocalSettings.php ]
then
    echo >&2 "Cannot copy file $MEDIAWIKI_SETTINGS_PATH/LocalSettings.php. File not found!"
else
	cp $MEDIAWIKI_SETTINGS_PATH/LocalSettings.php $MEDIAWIKI_HTML_PATH/LocalSettings.php
	echo "File $MEDIAWIKI_SETTINGS_PATH/LocalSettings.php successfully copied!"
fi
